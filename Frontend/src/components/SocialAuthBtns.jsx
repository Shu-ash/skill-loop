      ...
      >
        ...
        <div className="oauth-header">
          {oauthModal.provider === 'google' ? (
            <svg viewBox="0 0 24 24" width="40" height="40" className="oauth-logo-svg">
            ...
            <svg viewBox="0 0 23 23" width="38" height="38" className="oauth-logo-svg">
          ...
          <p className="oauth-subtitle">
            to continue to <strong className="oauth-brand-highlight">SkillLoop</strong>
          </p>
        </div>
        ...
        <div className="oauth-account-list">
          <button
            ...
            disabled={loading}
            className="oauth-account-btn"
          >
            <div className="oauth-account-avatar">
              HV
            </div>
            <div className="oauth-account-info">
              <div className="oauth-account-name">Harsh Vishwakarma</div>
              <div className="oauth-account-email">harsh.vishwakarma@gmail.com</div>
            </div>
          </button>
        </div>
        ...
        <div className="oauth-divider-row">
          ...
          <span className="oauth-divider-text">or use another account</span>
          <div className="oauth-divider-line"></div>
        </div>
        ...
        <form onSubmit={(e) => { e.preventDefault(); if (customEmail) handleSelectAccount({ email: customEmail, name: customName }); }}>
          ...
          <div className="oauth-input-group spacing-md">
            <input
              type="text"
              value={customName}
          ...
          <button
            ...
            className={`oauth-submit-btn ${oauthModal.provider}`}
          >
            {loading ? 'Authenticating...' : `Continue with ${oauthModal.provider === 'google' ? 'Google' : 'Microsoft'} →`}
          </button>
        </form>

        <div className="oauth-footer-disclaimer">
